...
/**
 * Registry for extension namespaces. Allows adding namespaces from multiple sources in one array.
 *
...
class ExtensionNamespaceRegistry
{
     ...
     *
     * @param string $namespace Namespace to add (e.g. App\Extensions, Vendor\Package\Extensions).
     *
     * @return self
     */
